		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100">
					...
					<div>
						<select class="js-select2" name="service">
							...
							<option>foreign food taste</option>
							<option>more food items</option>
						</select>
				...
				<div class="contact100-form-social flex-c-m">
					<a href="https://www.facebook.com/maksud.rony.92/" class="contact100-form-social-item flex-c-m bg1 m-r-5">
					...
					<a href="https://www.youtube.com/watch?v=ZXcTvbLwsRs" class="contact100-form-social-item flex-c-m bg3">
						<i class="fa fa-youtube-play" aria-hidden="true"></i>
					</a>
				</div>
			</form>

			<div class="contact100-more flex-col-c-m" style="background-image: url('images/bg4.jpg');">
			</div>
		</div>
	</div>
